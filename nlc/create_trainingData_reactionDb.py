...
for line in lines:
    ...
    # トレーニングデータ作成
    recieve_sentence,class1,class2,class3,class4,reply_phrase,reaction,dialog_name,rr_name = line.rstrip("\n\r").split(',');
